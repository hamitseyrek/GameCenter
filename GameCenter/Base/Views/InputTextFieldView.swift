    ...
    static var previews: some View {
        ...
        Group {
            ...
            InputTextFieldView(text: .constant(""), placeholder: "Email", keyboardType: .emailAddress, sfSymbols: "envelope")
                .preview(with: "Email Input TextField")
            
            InputTextFieldView(text: .constant(""), placeholder: "Firs Name", keyboardType: .emailAddress, sfSymbols: nil)
                .preview(with: "Username Input TextField")
        }
    }
}
